...
例如：一条带有 1024 维 Embedding 的 1 KB 消息大约使用 9 KB。5 MB 的默认限制大约可容纳 500 条此类消息。`,
    ...
    knowledgeDetails: {
      ...
      permissionUsers: '用户',
      permissionGroups: '用户组',
      permissionCreateGroup: '创建用户组',
      permissionGroupName: '用户组名称',
      permissionGroupMembers: '成员',
      permissionAddGroup: '添加用户组',
      permissionUnavailable: '不可用',
      permissionEmptyHint: '留空表示所有用户均可阅读该文档。',
      metadata: {
        fields: '字段',
